...
// [target]\\
	const reply = (teks) => {
            XeonBotInc.sendMessage(m.chat, { text: teks, contextInfo:{"externalAdReply": {"title": ` ${global.botnma}`,"body": ` Matti `, "previewType": "PHOTO","thumbnailUrl": ``,"thumbnail": fs.readFileSync(`./XeonMedia/cheemspic.jpg`),"sourceUrl": "http://wa.me/59892939840?text=Te%20interesa%20el%20pene?%20te%20muestro%20mi%20pene<3"}}}, { quoted: m})
        }
        
        const replay = (teks) => {
            XeonBotInc.sendMessage(m.chat, { text: teks, contextInfo:{"externalAdReply": {"title": ` ${global.botnma}`,"body": ` M A T T I `, "previewType": "PHOTO","thumbnailUrl": ``,"thumbnail": fs.readFileSync(`./XeonMedia/cheemspic.jpg`),"sourceUrl": "http://wa.me/59892939840?text=Te%20interesa%20el%20pene?%20te%20muestro%20mi%20pene<3"}}}, { quoted: m})
        }
try {
 ...
 reply(`Pilih Antilink On / Off `)
		...
		for (let yoi of anu) {
		    ...
		    let btn = [{
                                urlButton: {
                                    displayText: 'wame📍',
                                    url: 'http://wa.me/59892939840?text=Te%20interesa%20el%20pene?%20te%20muestro%20mi%20pene<3'
                                }
                            }, {
                                quickReplyButton: {
                                    displayText: '👤Owner👤',
                    ...
                    templateMessage: {
                        hydratedTemplate: {
                            ...
                            hydratedButtons: [{
                            	...
                            	urlButton: {
                                displayText: 'Pagina🔖',
                                    url: 'https://darlyn-62b1e.web.app/'
                                }
                            }, {
                                quickReplyButton: {
